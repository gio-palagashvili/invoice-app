...
const Nav = (props) => {
  return (
    <div className="bg-[#1F2139] w-full h-[5rem] rounded-tr-xl flex lg:w-[6rem] lg:h-[100vh] lg:flex-col lg:rounded-br-3xl lg:rounded-tr-3xl fixed z-10">
      <div className="logo bg-[#7C5DFA] h-full rounded-tr-3xl rounded-br-3xl flex justify-center w-[80px] lg:flex-col lg:w-full lg:h-[90px]">
        <img
          ...
          alt=""
          className="w-[31px] h-[28px] self-center"
        />
      </div>
